//
//  ChosenPlayListCollectionView.swift
//  YouTubePlayerTest
//
//  Created by Andrew Matsota on 26.06.2020.
...
class ChosenPlayListCollectionView: UICollectionViewCell {
    
    var videoId: String?
    
    /// Cell modifier
    static let identifier = "ChosenPlayListCollectionView"
    static func nib() -> UINib {
        return UINib(nibName: "ChosenPlayListCollectionView", bundle: nil)
    }
        ...
        request = NetworkMaganer.shared.loadCertainVideo(id: videoId, success: { (data) in
            DispatchQueue.main.async {
                ...
                if let url = URL(string: (imageURL.first!!)) {
                    ...
                    self.thumbnailsImageView.layer.cornerRadius = 10
                }else{
    ...
    //MARK: Image View
    @IBOutlet private weak var thumbnailsImageView: UIImageView!
